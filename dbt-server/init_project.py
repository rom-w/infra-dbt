...
# state_id = "edcbb60d998f14a28f160a292d6235cd"
# state_id = "fbe56f3f95cd5654044b76652a3f0aa7"
...
resp = requests.post(SERVER_HOST_COMPILE, json={"state_id": state_id, "sql": sql, "target": "dev"})
# print("resp: ", json.loads(resp.content))
#
...
# print (state_id)
#
# resp = requests.post(SERVER_HOST_MEM+"list", json={"state_id": state_id, "output": "selector"})
# print("resp: ", json.loads(resp.content))